<?php
// Trae la lista de usuarios del sitio (RESTAURANTE_API_URL) para que este
// receptor use el MISMO inicio de sesión -- la API Key nunca la ve el navegador.
...
$ch = curl_init(rtrim($baseUrl, '/') . '/api/get-users.php');
