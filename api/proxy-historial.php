<?php
// Trae el historial PERMANENTE de ventas del sitio (RESTAURANTE_API_URL) para
// la pestaña de Admin -- la API Key nunca la ve el navegador.
...
$ch = curl_init(rtrim($baseUrl, '/') . '/api/get-historial.php');
